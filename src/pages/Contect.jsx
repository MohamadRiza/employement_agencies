  ...
  return (
    <section className="relative py-20 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://images.pexels.com/photos/1024248/pexels-photo-1024248.jpeg')",
        }}
      ></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-white/50 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 border-b pb-3">Our Office</h3>
