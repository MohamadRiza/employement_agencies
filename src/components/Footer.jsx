...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-gray-900/20 to-black/20"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-14">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-blue-900 inline-block text-transparent bg-clip-text">
              ABC Agencies (PVT) LTD
            </h3>
            <p className="text-gray-300 leading-relaxed mb-6 max-w-xs mx-auto md:mx-0">
              Sri Lanka’s leading manpower agency with over 40 years of excellence in global recruitment and visa consulting.
            </p>
            <Link
              to="/about"
          ...
          <div className="text-center md:text-right">
            ...
            <div className="text-gray-300 space-y-3 text-sm leading-relaxed">
              <div>
                ...
                <p>No: 01, Colombo Road,</p>
                <p>Narammala, Sri Lanka</p>
              </div>
              <div>
                <p>
                  📞{" "}
        ...
        <div className="relative border-t border-gray-700 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0 text-sm text-gray-400">
            <p>
              ...
              <span className="text-white font-medium">ABC Agencies (PVT) LTD</span>. All rights reserved.
            </p>
            <p className="text-blue-300 font-medium">
              Developed by{" "}
              <span className="text-white hover:text-blue-200 transition">Riza</span>
            </p>
          </div>
        </div>
      </div>
